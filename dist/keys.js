...
(function (JobHandlerBindings) {
    JobHandlerBindings.COMPONENT = core_1.BindingKey.create(`${core_1.CoreBindings.COMPONENTS}.LoopbackBull`);
    JobHandlerBindings.JOB_HANDLER_OBSERVER_GROUP = 'LoopbackBull';
    JobHandlerBindings.JOB_HANDLER_CONSUMER_BASE_PATH = 'LoopbackBull.consumers';
